...
import { useNavigate } from "react-router-dom";
  ...
  const UnplannedWorkOrders = ({ onAdd, externalData = [], onSelect }) => {
    ...
    useEffect(() => {
      const handleSubmit = (e) => {
        if (e.detail.formType === "Unplanned Work Order") {
    ...
    return (
      <div className="bg-white rounded-xl border p-4 flex-1 max-h-[500px] flex flex-col">
        {/* Header */}
        <div className="flex justify-between items-center mb-2">
          <h2 className="text-lg font-semibold">Unplanned Work Orders</h2>
        ...
        <input
          type="text"
          placeholder="Search for unplanned workorders..."
